...
class GuestController extends Controller
{
    ...
    public function index()
    {
       ...
       // dd(request()->cookie('serializedCart'));
        ...
        $pays=Pays::InRandomOrder()->whereHas('actualite',function($q){$q->where('publie',1);})->first();
        ...
        return view('welcome',compact('comingevents','artistes','actus','albums','singles','newsingles',
        'recommandes','lives','evenements','pays','actuspays','flashactus','flashevents','topcats','lastevent','listlastevents',
        'slidescats'));
    }
    ...
    public function artistes()
    {
        ...
        $date=date('Y-m-d');
        $artistes=User::where('role','Artiste')->where('valide','oui')->where('nomartiste','!=',NULL)->where('description','!=',NULL)->paginate('24');
    ...
    public function detailsartistes($heavenid)
    {
        ...
        return view('detailsartistes',compact('artistes','singles','albums','derniersalbums','videos'));
    }
    ...
    public function detailsalbums($slug)
    {
        ...
        return view('detailsalbums',compact('album','singles','autresalbums'));
    }
