        ...
        <div class="tab-content dashboard-content">
            <div class="tab-pane fade active show" id="dashboard" role="tabpanel" aria-labelledby="dashboard-tab">
                <div class="card">
                    ...
                    <div class="card-body">
                        <p>Depuis le tableau de bord de votre compte, vous pouvez facilement publier vos
                            <a href="javascript:void(0);" onclick="$('#orders-tab').trigger('click')">singles</a>, manager vos
                            <a href="javascript:void(0);" onclick="$('#address-tab').trigger('click')">Albums</a> et
                            <a href="javascript:void(0);" onclick="$('#account-detail-tab').trigger('click')">modifier votre
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3 col-md-6 mb-4">
                                <div class="card" style="background-color: #d8d2d3fb; color: white; shadow-none card-lift">
                                    <div class="card-body">
