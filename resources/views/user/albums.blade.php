            ...
            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-12 col-md-2">
                                        <a href="{{route('welcome')}}" class="sign__logo text-center">
                                            <img src="{{asset('PlayerTemplate/img/covers/cover.svg')}}" id="blah1" class="img-responsive img-thumbnail" alt="">
                                        </a>
                                    </div>
                                    <div class="col-12 col-md-5">
                                        <div class="form-group {{ $errors->has('cover') ? ' has-error' : '' }}">
                                            <label class="sign__label" for="cover">Selectionnez la Cover</label>
                                            <input type="file" class="form-control" value="" name="cover" id="cover" style="padding: 8px;">
                                            @if ($errors->has('cover'))
                                    ...
                                    <div class="col-12 col-md-5">
                                        <div class="form-group {{ $errors->has('titre') ? ' has-error' : '' }}">
                                            ...
                                            <input type="text" class="form-control" value="{{old('titre')}}" name="titre" id="titre"  placeholder="Titre de l'album">
                                            @if ($errors->has('titre'))
                                                <span class="invalid-feedback" role="alert">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="border p-md-4 p-30">
                            <div class="heading_s1 mb-3">
                                <h6><i class="ti-folder"></i>  Albums Publiés <span class="badge badge-danger">{{$albums->where('statut','En Ligne')->where('masque',0)->count()}}</h6><hr>
                            </div>
                                    ...
                                    <tbody>
                                        ...
                                        @forelse ($albums as $album)
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="main__table-text">{{ $album->created_at->format('d M Y') }}</div>
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                    ...
                                                    @if ($album->statut =="En Attente")
                                                        <span class="badge badge-warning"><span class="ti-clock"></span> En Attente</span>
                                                    @endif
                                                    @if ($album->statut =="Restreint")
                                                        <span class="badge badge-danger"><span class="ti-remove"></span>  Restreint</span>
                                                    @endif
                                                </td>
                                                <td>
                                                    <ul class="list-unstyled list--inline">
                                                        <li class="single-item mb-3">
                                                            <a href="{{route('user.titrealbums',['slug'=>$album->slug])}}" class="btn btn-primary" title="Ajouter des Titres">
