        ...
        <div class="archive-header text-center bg-grey mt-5 pt-30 pb-30">
            <div class="container">
                <div class="breadcrumb">
                    ...
                    <span></span>
                    <a href='{{ route('plan') }}'>Plans Tarifaire</a>
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-md-4">
                    <div class="card text-center shadow-lg p-4 mb-4">
                        ...
                        <a href="{{ route('detailsbasique') }}" class="btn btn-primary">Voir plus</a>
                ...
                <div class="col-md-4">
                    <div class="card text-center shadow-lg p-4 mb-4">
                        ...
                        <a href="{{ route('detailsstandard') }}" class="btn btn-primary">Voir plus</a>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="card text-center shadow-lg p-4 mb-4">
                        ...
                        <a href="{{ route('detailspremiun') }}" class="btn btn-primary">Voir plus</a>
                    </div>
                </div>
            </div>
        </div>
