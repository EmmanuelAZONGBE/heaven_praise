				...
				<div class="row">
					<div class="col-12 col-md-4">
						<div class="card">
							...
							<div class="card-body">
                                <form action="{{route('admin.updatecommunaute',['id'=>$find->id])}}" method="post">
                                    {{ csrf_field() }}
                                    <div>
                                        <!-- input -->
										...
										<tbody>
                                            ...
                                            @forelse ($communautes as $communaute)
                                                <tr>
                                                    ...
                                                    <td>
                                                        {{$artistes->where('communaute_id',$communaute->id)->count()}}
                                                    </td>
                                                    <td>
                                                        {{$utilisateurs->where('communaute_id',$communaute->id)->count()}}
                                                    </td>
                                                    <td>
