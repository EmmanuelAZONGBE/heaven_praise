                    ...
                    <div class="row">
                        <div class="col-12 col-md-4">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form
                                        action="{{ route('admin.updateforumspays', ['id' => $find->id, 'idforum' => $findforum->id]) }}"
                                        method="post">
                                        {{ csrf_field() }}
                                        <div>
                                            <!-- input -->
                                            ...
                                            <tbody>
                                                ...
                                                @forelse ($forums as $forum)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            @if ($forum->actif == 0)
                                                                <a href="{{ route('admin.activateforumspays', ['id' => $forum->id]) }}"
                                                            ...
                                                            @endif
                                                            <a href="{{ route('admin.editforumspays', ['id' => $find->id, 'idforum' => $forum->id]) }}"
                                                            ...
                                                            <form
                                                                action="{{ route('admin.deleteforum', ['id' => $forum->id]) }}"
