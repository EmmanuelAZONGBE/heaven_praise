                                ...
                                <form action="{{route('admin.storepays')}}" method="post">
                                    ...
                                    <div>
                                        ...
                                        <div class="mb-3  {{ $errors->has('libelle') ? ' has-error' : '' }}">
                                            ...
                                            <input type="text" name="libelle" value="{{old('libelle')}}" class="form-control" placeholder="Entrez le nom du pays">
                                        ...
                                        <div class="mb-3  {{ $errors->has('indicatif') ? ' has-error' : '' }}">
                                            ...
                                            <input type="text" name="indicatif" value="{{old('indicatif')}}" class="form-control" placeholder="Indicatif du pays">
