                    ...
                    <div class="row">
                        <div class="col-12 col-md-4">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form action="{{ route('admin.storepays') }}" method="post">
                                        {{ csrf_field() }}
                                        <div>
                                            <!-- input -->
                                            <div class="mb-3  {{ $errors->has('libelle') ? ' has-error' : '' }}">
                                                ...
                                                <input type="text" name="libelle" value="{{ old('libelle') }}"
                                                    class="form-control" placeholder="Entrez le nom du pays">
                                            ...
                                            <div class="mb-3  {{ $errors->has('indicatif') ? ' has-error' : '' }}">
                                                ...
                                                <input type="text" name="indicatif" value="{{ old('indicatif') }}"
                                                    class="form-control" placeholder="Indicatif du pays">
                                                ...
                                                @forelse ($pays as $pays)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <a href="{{ route('admin.forumspays', ['id' => $pays->id]) }}"
                                                            ...
                                                            <a href="{{ route('admin.editpays', ['id' => $pays->id]) }}"
                                                            ...
                                                            <form
                                                                action="{{ route('admin.deletepays', ['id' => $pays->id]) }}"
                                                                method="POST"
