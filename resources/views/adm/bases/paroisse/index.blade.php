                    ...
                    <div class="row">
                        <div class="col-12 col-md-4">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form action="{{ route('admin.storeparoisse') }}" method="post">
                                        {{ csrf_field() }}
                                        <div>
                                            <!-- select -->
                                            <div class="mb-3  {{ $errors->has('pays') ? ' has-error' : '' }}">
                                                ...
                                                <select name="pays" id="" class="form-control">
                                                    @forelse ($pays as $pays)
                                                        @if (old('pays') == $pays->id)
                                                            <option value="{{ $pays->id }}" selected>
                                                                {{ $pays->libelle }}</option>
                                                        @else
                                                            <option value="{{ $pays->id }}">{{ $pays->libelle }}
                                                            </option>
                                                        @endif
                                            ...
                                            <div class="mb-3  {{ $errors->has('communaute') ? ' has-error' : '' }}">
                                                ...
                                                <select name="communaute" id="" class="form-control">
                                                    @forelse ($communautes as $communaute)
                                                        @if (old('communaute') == $communaute->id)
                                                            <option value="{{ $communaute->id }}" selected>
                                                                {{ $communaute->libelle }}</option>
                                                        @else
                                            ...
                                            <div class="mb-3  {{ $errors->has('libelle') ? ' has-error' : '' }}">
                                                ...
                                                <input type="text" name="libelle" value="{{ old('libelle') }}"
                                                    class="form-control" placeholder="Entrez le nom de la Paroisse">
                                            ...
                                            <tbody>
                                                ...
                                                @forelse ($paroisses as $paroisse)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            {{ $paroisse->Pays->libelle }} /
                                                            {{ $paroisse->Communaute->libelle }}
                                                        </td>
                                                        <td>
                                                        ...
                                                        <td>
                                                            ...
                                                            <a href="{{ route('admin.forumsparoisse', ['id' => $paroisse->id]) }}"
                                                                class="btn btn-ghost btn-icon btn-sm rounded-circle texttooltip"
                                                                data-template="forumOne">
                                                                <i data-feather="users" class="icon-xs"></i>
                                                                <div id="forumOne" class="d-none">
                                                                    <span>Forums</span>
                                                                </div>
                                                            </a>
                                                            <a href="{{ route('admin.editparoisse', ['id' => $paroisse->id]) }}"
                                                            ...
                                                            <a href="#!"
                                                                ...
                                                                <form
                                                                    action="{{ route('admin.deleteparoisse', ['id' => $paroisse->id]) }}"
                                                                    method="POST"
                                                                    onsubmit="return confirm('Voulez-vous vraiment supprimer cette paroisse ?');"
