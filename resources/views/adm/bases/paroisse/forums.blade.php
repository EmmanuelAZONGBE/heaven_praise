				...
				<div class="row">
					<div class="col-12 col-md-4">
						<div class="card">
							...
							<div class="card-body">
                                <form action="{{route('admin.storeforumsparoisse',['id'=>$find->id])}}" method="post">
                                    {{ csrf_field() }}
                                    <div>
                                        <!-- input -->
                                            ...
                                            @forelse ($forums as $forum)
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        @endif
                                                        <a href="{{route('admin.editforumsparoisse',['id'=>$find->id,'idforum'=>$forum->id])}}" class="btn btn-ghost btn-icon btn-sm rounded-circle texttooltip"data-template="editOne">
                                                            <i data-feather="edit" class="icon-xs"></i>
                                                            <div id="editOne" class="d-none">
                                                                <span>Éditer</span>
                                                            </div>
                                                        </a>
                                                        <form action="{{ route('admin.deleteforumsparoisse', ['id' => $forum->id]) }}" method="POST" onsubmit="return confirm('Voulez-vous vraiment supprimer ce forum ?');" style="display:inline;">
                                                            @csrf
                                                            @method('DELETE')
