                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <img src="{{ asset('usx_files/promotions/' . $promotion->banniere) }}"
                                                                    alt="" class="img-4by3-sm rounded-3">
                                                                <div class="ms-3">
                                                                    <h5 class="mb-0">
                                                                        Bannière @if ($promotion->position == 'En-tête')
                                                                            380px x 56px
                                                                        @else
                                                                            370px x 171px
                                                                        @endif
                                                        ...
                                                        <td>
                                                            ...
                                                            @if (!empty($promotion->actualite_id))
                                                                @php
                                                                    $actu = App\Models\Actualite::find(
                                                                        $promotion->actualite_id,
                                                                    );
                                                                @endphp
                                                            ...
                                                            @if (!empty($promotion->evenement_id))
                                                                @php
                                                                    $event = App\Models\Actualite::find(
                                                                        $promotion->evenement_id,
                                                                    );
                                                                @endphp
                                                        ...
                                                        <td>
                                                            <div class="dropdown">
                                                                ...
                                                                <ul class="dropdown-menu">
                                                                    <li>
                                                                        <form
                                                                            action="{{ route('admin.deletepromotion', ['id' => $promotion->id]) }}"
                                                                            method="POST"
