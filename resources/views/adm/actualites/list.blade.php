                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <img src="{{asset('usx_files/actus/'.$actu->banniere)}}" alt="" class="img-4by3-sm rounded-3">
                                                            <div class="ms-3">
                                                                <h5 class="mb-0">
                                                                    {{$actu->titre}}
                                                                </h5>
                                                    ...
                                                    <td>
                                                        <div class="dropdown">
                                                            ...
                                                            <ul class="dropdown-menu">
                                                                @if ($actu->publie==1)
                                                                    <li><a class="dropdown-item d-flex align-items-center" href="{{route('admin.depublieractus',['id'=>$actu->id])}}">Masquer</a></li>
                                                                @else
                                                                    <li><a class="dropdown-item d-flex align-items-center" href="{{route('admin.publieractus',['id'=>$actu->id])}}">Publier</a></li>
                                                                @endif

                                                                <li><a class="dropdown-item d-flex align-items-center" href="{{route('admin.editactus',['id'=>$actu->id])}}">Éditer</a></li>
                                                                <li><a class="dropdown-item d-flex align-items-center" href="#!">Commentaires</a></li>
