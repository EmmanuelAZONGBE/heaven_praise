...
<div id="app-content">
	...
	<div class="app-content-area">
		<div class="container-fluid">
			...
			<div>
            <form action="{{route('admin.storeactus')}}" method="post" enctype="multipart/form-data">
                {{ csrf_field() }}
				<!-- row -->
				<div class="row">
							...
							<div class="card-body">
								<div>
									...
									<div class="mb-3  {{ $errors->has('titre') ? ' has-error' : '' }}">
										<label class="form-label">Titre de l'Actualités</label>
										<input type="text" name="titre" class="form-control" value="{{old('titre')}}" placeholder="Entrez l'intitulé de l'actualité" >
									    @if ($errors->has('titre'))
									...
									<div class="mb-3  {{ $errors->has('slug') ? ' has-error' : '' }}">
										...
										<input type="text" name="slug" class="form-control" value="{{old('slug')}}" placeholder="Exemple : nom-de-l-actualite" >
									    @if ($errors->has('slug'))
                                            <div class="alert" role="alert">
									...
									<div class="  {{ $errors->has('details') ? ' has-error' : '' }}">
										...
										<textarea  class="form-control" name="details" id="texteditor" cols="30" rows="10">{!!old('details')!!}
                                        </textarea>
								...
								<div>
									...
									<div class="mb-3  {{ $errors->has('statut') ? ' has-error' : '' }}">
										...
										<select class="form-select" name="statut" aria-label="Default select example">
											...
											<option  value="0"  {{old('statut')==0 ? 'selected' : ''}} >Non Publié</option>
										</select>
