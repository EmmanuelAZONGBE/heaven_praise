                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <img src="{{asset('usx_files/events/'.$event->banniere)}}" alt="" class="img-4by3-sm rounded-3">
                                                            <div class="ms-3">
                                                                <h5 class="mb-0">
                                                                    {{$event->titre}}
                                                                </h5>
                                                    ...
                                                    <td>
                                                        <div class="dropdown">
                                                            ...
                                                            <ul class="dropdown-menu">
                                                                @if ($event->statut=="Publié")
                                                                    <li><a class="dropdown-item d-flex align-items-center" href="{{route('admin.depublierevents',['id'=>$event->id])}}">Masquer</a></li>
                                                                @else
                                                                    <li><a class="dropdown-item d-flex align-items-center" href="{{route('admin.publierevents',['id'=>$event->id])}}">Publier</a></li>
                                                                @endif
                                                                @if ($event->billeterie==1)
                                                                    <li><a class="dropdown-item d-flex align-items-center" href="{{route('admin.billeterieevents',['id'=>$event->id])}}">Gestion Billeterie</a></li>
                                                                @endif

                                                                <li><a class="dropdown-item d-flex align-items-center" href="{{route('admin.editevents',['id'=>$event->id])}}">Éditer</a></li>
