                                                                ...
                                                                <div class="ms-3">
                                                                    <h5 class="mb-0">
                                                                        <a href="{{ route('admin.detailsalbum', ['id' => $album->id]) }}"
                                                                            class="text-inherit">{{ $album->titre }}<br><small>{{ $album->User->nomartiste }}</small></a>
                                                                    </h5>
                                                                </div>
                                                            </div>
                                                        </td>
                                                            ...
                                                            <div class="dropdown">
                                                                ...
                                                                <ul class="dropdown-menu">
                                                                    ...
                                                                    @if (Route::currentRouteName() == 'admin.visiblesalbums' || Route::currentRouteName() == 'admin.maskedalbums')
                                                                        @if ($album->masque == '0')
                                                                            <li><a class="dropdown-item d-flex align-items-center"
                                                                                    href="{{ route('admin.maskalbum', ['id' => $album->id]) }}">Masquer</a>
                                                                            </li>
                                                                        @else
                                                                            <li><a class="dropdown-item d-flex align-items-center"
                                                                                    href="{{ route('admin.unmaskalbum', ['id' => $album->id]) }}">Rendre
                                                                                    visible</a></li>
                                                                        @endif
                                                                    @endif
