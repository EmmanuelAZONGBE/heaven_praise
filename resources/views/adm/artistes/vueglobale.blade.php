                            ...
                            <ul class="list-unstyled list-inline">
                                @if ($find->valide == 'oui')
                                    <li class="list-inline-item">
                                        <a href="{{ route('admin.unvalidateartist', ['id' => $find->id]) }}"
                                            class="btn btn-warning">Suspendre</a>
                                    </li>
                                @else
                                    <li class="list-inline-item">
                                        <a href="{{ route('admin.validateartist', ['id' => $find->id]) }}"
                                            class="btn btn-success">Valider</a>
                                    </li>
                                @endif
                                @if ($find->restreint == '0')
                                    <li class="list-inline-item">
                                        <a href="{{ route('admin.restrictartist', ['id' => $find->id]) }}"
                                            class="btn btn-danger">Restreindre</a>
                                    </li>
                                @else
                                    <li class="list-inline-item">
                                        <a href="{{ route('admin.unrestrictartist', ['id' => $find->id]) }}"
                                            class="btn btn-primary">Lever Restriction</a>
                                    </li>
                                @endif
                            </ul>
                        </div>
                            ...
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-center mb-8">
                                    <div class="d-flex align-items-center">
                                        ...
                                        @else
                                            <img src="{{ asset('usx_files/avatars/' . $find->avatar) }}"
                                                class="avatar-lg avatar rounded-circle">
                                        @endif
                                        <div class="ms-3">
                                            <h4 class="mb-0">
                                                @if (!empty($find->nomartiste))
                                                    {{ $find->nomartiste }}
                                                @else
                                                    <small><em>Nom d'artiste non défini</em></small>
                                                @endif
                                            </h4>
                                            <small>
                                                Artiste
                                    ...
                                    <div>
                                        <a href="{{ route('admin.editartist', ['id' => $find->id]) }}"
                                            class="btn btn-primary">Editer Profile</a>
                                    </div>
                                </div>
                                <div class="mb-8">
                                    <h5>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="mb-6">
                                            ...
                                            <h5 class="mb-0 mt-2">
                                                @if (!empty($find->pays_id))
                                                    {{ $find->Pays->libelle }}
                                                @else
                                                    <em>Non Défini</em>
                                                    @endif / @if (!empty($find->communaute_id))
                                                        {{ $find->Communaute->libelle }}
                                                    @else
                                                        <em>Non Défini</em>
                                                    @endif
                                            </h5>
                                        ...
                                        <div class="mb-4">
                                            <h4 class="mb-0">
                                                ...
                                                <span class="texttooltip" data-template="alertOne">
                                                    ...
                                                    <span id="alertOne" class="d-none"><span
                                                            class="mb-0 text-white fs-6">Text</span></span>
                                                </span>
                                            </h4>
                                        </div>
                                        <div class="mb-6">
                                            ...
                                            <span>
                                                <span class="text-success "><i data-feather="arrow-up"
                                                        class="icon-xxs"></i>20.00%</span>
                                ...
                                <div class="card bg-gray-200 shadow-none card-lift">
                                    <div class="card-body">
                                        ...
                                        <div class="mb-6">
                                            ...
                                            <span>
                                                <span class="text-danger "><i data-feather="arrow-down"
                                                        class="icon-xxs"></i>7.00%</span>
                                                <span class="text-muted">vs </span>
                                                <span>Last Month</span>
                                            </span>
                                        </div>
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <div class="ms-3">
                                                                ...
                                                                <figure>
                                                                    <audio
                                                                        style="width: 220px; height:30px; margin-top:10px;"
                                                                        controls
                                                                        src="{{ asset('usx_files/songs/' . $single->audio) }}">
                                                                        <a
                                                                            href="{{ asset('usx_files/songs/' . $single->audio) }}">
                                                                            Jouer
                                                                        </a>
                                                                    </audio>
                                                                </figure>
                                                            ...
                                                            <ul class="dropdown-menu">
                                                                @if ($single->statut == 'En Attente')
                                                                    <li><a class="dropdown-item d-flex align-items-center"
                                                                            href="{{ route('admin.validatesingle', ['id' => $single->id]) }}">Valider</a>
                                                                    </li>
                                                                @else
                                                                    <li><a class="dropdown-item d-flex align-items-center"
                                                                            href="{{ route('admin.unvalidatesingle', ['id' => $single->id]) }}">Mettre
                                                                            en attente</a></li>
                                                                @endif
                                                                @if ($single->statut != 'Restreint')
                                                                    <li><a class="dropdown-item d-flex align-items-center"
                                                                            href="{{ route('admin.restrictsingle', ['id' => $single->id]) }}">Restreindre</a>
                                                                    </li>
                                                                @endif
                                                                ...
                                                                @if (Route::currentRouteName() == 'admin.visiblessingles' || Route::currentRouteName() == 'admin.maskedsingles')
                                                                    @if ($single->masque == '0')
                                                                        <li><a class="dropdown-item d-flex align-items-center"
                                                                                href="{{ route('admin.masksingle', ['id' => $single->id]) }}">Masquer</a>
                                                                        </li>
                                                                    @else
                                                                        <li><a class="dropdown-item d-flex align-items-center"
                                                                                href="{{ route('admin.unmasksingle', ['id' => $single->id]) }}">Rendre
                                                                                visible</a></li>
                                                                    @endif
                                                                @endif

                                                                <li><a class="dropdown-item d-flex align-items-center"
                                                                        href="{{ route('admin.editsingle', ['id' => $single->id]) }}">Éditer</a>
                                                                </li>
                                                                <li>
                                                                    <form
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <div class="ms-3">
                                                                <h5 class="mb-0">
                                                                    <a href="{{ route('admin.detailsalbum', ['id' => $album->id]) }}"
                                                                        class="text-inherit">{{ $album->titre }}</a>
                                                                </h5>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    ...
                                                    <td>
                                                        <div class="dropdown">
                                                            ...
                                                            <ul class="dropdown-menu">
                                                                <li><a class="dropdown-item d-flex align-items-center"
                                                                        href="{{ route('admin.detailsalbum', ['id' => $album->id]) }}">Détails</a>
                                                                </li>
                                                                @if ($album->statut == 'En Attente')
                                                                    <li><a class="dropdown-item d-flex align-items-center"
                                                                            href="{{ route('admin.validatealbum', ['id' => $album->id]) }}">Valider</a>
                                                                    </li>
                                                                @else
                                                                    <li><a class="dropdown-item d-flex align-items-center"
                                                                            href="{{ route('admin.unvalidatealbum', ['id' => $album->id]) }}">Mettre
                                                                            en attente</a></li>
                                                                @endif
                                                                @if ($album->statut != 'Restreint')
                                                                    <li><a class="dropdown-item d-flex align-items-center"
                                                                            href="{{ route('admin.restrictalbum', ['id' => $album->id]) }}">Restreindre</a>
                                                                    </li>
                                                                @endif
                                                                <li><a class="dropdown-item d-flex align-items-center"
                                                                        href="{{ route('admin.editalbum', ['id' => $album->id]) }}">Éditer</a>
                                                                </li>
                                                                <li>
                                                                    <form
                                                                        action="{{ route('admin.deletealbum', ['id' => $album->id]) }}"
                                                                        method="POST"
