		...
		<div class="container-fluid">
			<div class="row">
				<div class="col-lg-12 col-md-12 col-12">
					...
					<!-- Page header -->
					<div class="mb-5">
						<h3 class="mb-0">Nouveaux Artistes</h3>
					</div>
				</div>
			</div>
			<div>
					...
					<div class="col-12">
						<div class="card">
                            <div class="card-header">
                              Liste des Nouveaux Artistes Inscrits
                            </div>
							<div class="card-body">
										...
										<tbody>
                                            ...
                                            @forelse ($artistes as $artiste)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{route('admin.vueartist',['id'=>$artiste->id])}}"><strong>{{$artiste->nom}}</strong></a>
                                                    </td>
                                                    <td>
                                                        {{$artiste->created_at}}
                                                    </td>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="{{route('admin.editartist',['id'=>$artiste->id])}}" class="btn btn-ghost btn-icon btn-sm rounded-circle texttooltip"data-template="editOne">
