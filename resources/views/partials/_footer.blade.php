                            ...
                            <ul class="list-post">
                                <li class="mb-30">
                                    <div class="d-flex">
                                        ...
                                        <div class="post-content media-body">
                                            <h6 class="post-title mb-10 text-limit-2-row"><a class='color-white' href='/demo/single'>Traveling Tends to Magnify All Human Emotions</a></h6>
                                ...
                                <li class="mb-30">
                                    <div class="d-flex">
                                        ...
                                        <div class="post-content media-body">
                                            <h6 class="post-title mb-10 text-limit-2-row"><a class='color-white' href='/demo/single'>The Luxury Of Traveling With Yacht</a></h6>
                                ...
                                <li class="mb-30">
                                    <div class="d-flex">
                                        ...
                                        <div class="post-content media-body">
                                            <h6 class="post-title mb-10 text-limit-2-row"><a class='color-white' href='/demo/single'>Last Minute Festive Packages From Superbreak</a></h6>
                                            <div class="entry-meta meta-1 font-x-small color-grey mt-10">
                                                <span class="post-on">25 April</span>
                            ...
                            <ul class="list-post">
                                <li class="mb-30">
                                    <div class="d-flex">
                                        <div class="post-thumb d-flex mr-15 border-radius-5 img-hover-scale">
                                            <a class='color-white' href='/demo/single'>
                                                <img src="assets/imgs/thumbnail-13.jpeg" alt="">
                                            </a>
                                        </div>
                                        <div class="post-content media-body">
                                            <h6 class="post-title mb-10 text-limit-2-row"><a class='color-white' href='/demo/single'>Traveling Tends to Magnify All Human Emotions</a></h6>
                                ...
                                <li class="mb-30">
                                    <div class="d-flex">
                                        <div class="post-thumb d-flex mr-15 border-radius-5 img-hover-scale">
                                            <a class='color-white' href='/demo/single'>
                                                <img src="assets/imgs/thumbnail-11.jpeg" alt="">
                                            </a>
                                        </div>
                                        <div class="post-content media-body">
                                            <h6 class="post-title mb-10 text-limit-2-row"><a class='color-white' href='/demo/single'>Last Minute Festive Packages From Superbreak</a></h6>
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <div class="sidebar-widget widget_instagram">
                        ...
                        <div class="instagram-gellay">
                            <ul class="insta-feed">
                                <li>
                                    <a href="assets/imgs/thumbnail-3.jpeg" class="play-video" data-animate="zoomIn" data-duration="1.5s" data-delay="0.1s"><img class="border-radius-5" src="assets/imgs/thumbnail-12.jpeg" alt=""></a>
                                </li>
                                <li>
                                    <a href="assets/imgs/thumbnail-4.jpeg" class="play-video" data-animate="zoomIn" data-duration="1.5s" data-delay="0.1s"><img class="border-radius-5" src="assets/imgs/thumbnail-9.jpeg" alt=""></a>
                                </li>
                                <li>
                                    <a href="assets/imgs/thumbnail-5.jpeg" class="play-video" data-animate="zoomIn" data-duration="1.5s" data-delay="0.1s"><img class="border-radius-5" src="assets/imgs/thumbnail-10.jpeg" alt=""></a>
                                </li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="row d-flex align-items-center justify-content-between">
                    ...
                    {{-- <div class="col-lg-4">
                        <div class="social-icons mt-3">
                            <a href="https://www.facebook.com/Louangeceleste?mibextid=b06tZ0" target="_blank" class="social-icon"><i class="fab fa-facebook-f"></i></a>
                            <a href="" target="_blank" class="social-icon"><i class="fab fa-twitter"></i></a>
                            <a href="" target="_blank" class="social-icon"><i class="fab fa-instagram"></i></a>
                            {{-- <a href="https://www.linkedin.com" target="_blank" class="social-icon"><i class="fab fa-linkedin-in"></i></a> 
                            <a href="https://www.youtube.com/@heavenlypraise-louangeceleste" target="_blank" class="social-icon"><i class="fab fa-youtube"></i></a>
                        </div>
                    </div> --}}
                    ...
                    <div class="footer__social">
                        <a href="https://www.facebook.com/Louangeceleste?mibextid=b06tZ0" target="_blank"><svg
                        ...
                        <a href="https://twitter.com/HeavenlyPrais12" target="_blank"><svg width="30" height="30" viewBox="0 0 30 30"
                        ...
                        <a href="https://www.instagram.com/heavenlypraise2/?utm_source=qr&igshid=MzNlNGNkZWQ4Mg%3D%3D"
                        ...
                        <a href="https://www.youtube.com/@heavenlypraise-louangeceleste" target="_blank"><svg width="30" height="30" viewBox="0 0 30 30"
                                fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path
                                    d="M0 15C0 6.71573 6.71573 0 15 0C23.2843 0 30 6.71573 30 15C30 23.2843 23.2843 30 15 30C6.71573 30 0 23.2843 0 15Z"
                                    fill="#FF0000" />
