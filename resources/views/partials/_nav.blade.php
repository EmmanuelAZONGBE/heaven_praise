<aside id="sidebar-wrapper" class="custom-scrollbar offcanvas-sidebar position-right">
    ...
    <div class="sidebar-inner">
            ...
            <div class="post-block-list post-module-1 post-module-5">
                ...
                <ul>
                    @forelse ($categories as $categorie)
                        ...
                        @endphp
                        <li class="cat-item cat-item-2"><a href='#'>{{$categorie->libelle}}</a> ({{$count}})</li>
                    @empty
        ...
        <div class="sidebar-widget widget-ads mb-30">
            <a href="assets/imgs/news-1.jpeg" class="play-video" data-animate="zoomIn" data-duration="1.5s" data-delay="0.1s">
                ...
                <div class="row">
                    <div class="col-6">
                        ...
                        <div id="datetime" class="d-inline-block">
                            <ul>
                                ...
                                <li><span class="font-small"><i class="ti-calendar mr-5"></i>{{date('d M Y')}}</span></li>
                                <li><a class="color-white" href="#"><span class="font-small"><i class="ti-book mr-5"></i>Lire les dernières actus</span></a>
                                </li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-6 text-right">
                        <ul class="header-social-network d-inline-block list-inline color-white">
                            <li class="list-inline-item"><a class="social-icon facebook-icon text-xs-center color-white" target="_blank" href="https://www.facebook.com/Louangeceleste?mibextid=b06tZ0"><i class="ti-facebook"></i></a></li>
                            <li class="list-inline-item"><a class="social-icon twitter-icon text-xs-center color-white" target="_blank" href="https://twitter.com/HeavenlyPrais12"><i class="ti-twitter-alt"></i></a></li>
                            <li class="list-inline-item"><a class="social-icon instagram-icon text-xs-center color-white" target="_blank" href="https://www.instagram.com/heavenlypraise2/?utm_source=qr&igshid=MzNlNGNkZWQ4Mg%3D%3D"><i class="ti-instagram"></i></a></li>
                            <li class="list-inline-item"><a class="social-icon pinterest-icon text-xs-center color-white" target="_blank" href="https://www.youtube.com/@heavenlypraise-louangeceleste"><i class="ti-youtube"></i></a></li>
                        </ul>
                        <div class="vline-space d-inline-block"></div>
                        <div class="user-account d-inline-block font-small">
                            @if (Auth::guest())
                                <a class="color-white" href="{{route('login')}}" role="button" aria-haspopup="true" aria-expanded="false">
                                    <i class="ti-user"></i>
                            ...
                            @else
                                ...
                                <div id="userMenuDropdow" class="dropdown-menu dropdown-menu-right" aria-labelledby="userMenu">
                                    ...
                                    @if (Auth::user()->role == 'Artiste')
                                        <a class="dropdown-item" href="{{route('user.dashboard')}}"><i class="ti-home"></i>Dashboard</a>
                                    @endif
                                    @if (Auth::user()->role == 'Adm')
                                        <a class="dropdown-item" href="{{route('admin.dashboard')}}"><i class="ti-home"></i>Dashboard</a>
                                    @endif
            ...
            <div class="row">
                ...
                <div class="col-lg-10 col-md-12 align-center-vertical d-none d-lg-inline text-right">
                        ...
                        @if (!empty($ads->actualite_id))
                            ...
                            @endphp
                            <a href="{{route('detailsactualites',['slug'=>$actu->slug])}}" title="{{$actu->titre}}">
                        @endif
                        @if (!empty($ads->evenement_id))
                            @php
                                $event=App\Models\Evenement::find($ads->evenement_id);
                            @endphp
                            <a href="{{route('detailsevenements',['slug'=>$event->slug])}}" title="{{$event->titre}}">
                        @endif
                    
                        <img class="ads-img d-inline" src="{{asset('usx_files/promotions/'.$ads->banniere)}}" alt="">
                    </a>
                </div>
                @endif
            </div>
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="logo-mobile d-inline d-md-none">
                        <a href='{{route('welcome')}}'>
                            <img class="logo-img d-inline" src="{{asset('assets/imgs/logo.png')}}" alt="" style="width:120px;">
                        </a>
                    </div>
                    <!-- Main-menu -->
                                ...
                                <li class="mega-menu-item">
                                    ...
                                    <div class="sub-mega-menu">
                                        <div class="nav flex-column nav-pills" role="tablist">
                                            <a class="nav-link active" data-toggle="pill" href="#news-0" role="tab">Tous</a>
                                            @php
                                                $categories=App\Models\Categorie::InRandomOrder()->orderBy('libelle','Asc')->get()->take(5);
                                                $l=1;
                                            @endphp
                                            @forelse ($categories as $categorie)
                                                <a class="nav-link" data-toggle="pill" href="#news-{{$l}}" role="tab">{{$categorie->libelle}}</a>
                                                @php
                                                    $l=$l+1;
                                                @endphp
                                            @empty
                                        ...
                                        <div class="tab-content">
                                            <div class="tab-pane show active" id="news-0" role="tabpanel">
                                                <div class="row">
                                                    @php
                                                        $allactus=App\Models\Actualite::where('publie',1)->orderBy('id','Desc')->get()->take(4);
                                                    @endphp
                                                    @forelse($allactus as $allactu)
                                                        <div class="col-3 post-module-1">
                                                            <div class="post-thumb d-flex border-radius-5 img-hover-scale mb-15">
                                                                <a href='{{route('detailsactualites',['slug'=>$allactu->slug])}}'>
                                                                    <img src="{{asset('usx_files/actus/'.$allactu->banniere)}}" alt="">
                                                                </a>
                                                                @if ($allactu->flash==1)
                                                            ...
                                                            <div class="post-content media-body">
                                                                <h6 class="post-title mb-10 text-limit-2-row">{{$allactu->titre}}</h6>
                                                                <div class="entry-meta meta-1 font-x-small color-grey">
                                                                    <span class="post-on">{{ $allactu->created_at->format('d M Y') }}</span>
                                                                    <span class="hit-count has-dot">{{$allactu->vues}} Vues</span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    @empty
                                            ...
                                            @forelse($categories as $categorie)
                                                <div class="tab-pane" id="news-{{$l}}" role="tabpanel">
                                                    <div class="row">
                                                        @php
                                                            $actus=App\Models\Actualite::where('publie',1)->orderBy('id','Desc')->where('categorie_id',$categorie->id)->get()->take(4);
                                                        @endphp
                                                        @forelse($actus as $actu)
                                                        <div class="col-3 post-module-1">
                                                            <div class="post-thumb d-flex border-radius-5 img-hover-scale mb-15">
                                                                <a href='{{route('detailsactualites',['slug'=>$actu->slug])}}'>
                                                                    <img src="{{asset('usx_files/actus/'.$actu->banniere)}}" alt="">
                                                                </a>
                                                                @if ($actu->flash==1)
                                                                    <span class="top-right-icon background8"><i class="mdi mdi-flash-on"></i></span>
                                                                @endif
                                                            ...
                                                            <div class="post-content media-body">
                                                                <h6 class="post-title mb-10 text-limit-2-row">{{$actu->titre}}</h6>
                                                                <div class="entry-meta meta-1 font-x-small color-grey">
                                                                    <span class="post-on">{{ $actu->created_at->format('d M Y') }}</span>
                                                                    <span class="hit-count has-dot">{{$actu->vues}} Vues</span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    @empty
