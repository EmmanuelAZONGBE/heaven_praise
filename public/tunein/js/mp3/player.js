...
jQuery(document).ready(function(a) {
    ...
    adonisPlayer.init = function() {
        ...
        adonisPlaylist = new adonisJPlayerPlaylist({
            ...
            mp3: "tunein/js/mp3/Post Malone - Rockstar ft. 21 Savage (1).mp3",
            poster: "tunein/js/mp3/browse/browse-overview-4.webp"
        }], {
            playlistOptions: {
        ...
        mp3: "tunein/js/mp3/Post Malone - Rockstar ft. 21 Savage (1).mp3",
        poster: "tunein/js/mp3/browse/playlist-3.webp"
    }, {
        title: "Detour Some",
        ...
        mp3: "tunein/js/mp3/Post Malone - Rockstar ft. 21 Savage (1).mp3",
        poster: "tunein/js/mp3/browse/browse-overview-1.webp"
    }, {
        title: "You're A Mean",
        artist: "The Stark Palace{#link4}",
        mp3: "tunein/js/mp3/Post Malone - Rockstar ft. 21 Savage (1).mp3",
        poster: "tunein/js/mp3/browse/playlist-6.webp"
    }, {
        title: "may i right",
        artist: "Gunnar Olsen{#link3}",
        mp3: "tunein/js/mp3/Post Malone - Rockstar ft. 21 Savage (1).mp3",
        poster: "tunein/js/mp3/browse/browse-overview-6.webp"
    }, {
        title: "old man song",
        artist: "Ava Cornish{#link2}",
        mp3: "tunein/js/mp3/Post Malone - Rockstar ft. 21 Savage (1).mp3",
        poster: "tunein/js/mp3/browse/browse-overview-5.webp"
    }, {
        title: "bin tere sanam",
        artist: "Walking Promises{#link1}",
        mp3: "tunein/js/mp3/Post Malone - Rockstar ft. 21 Savage (1).mp3",
        poster: "tunein/js/mp3/browse/playlist-5.webp"
        ...
        mp3: "tunein/js/mp3/Post Malone - Rockstar ft. 21 Savage (1).mp3",
        poster: "tunein/js/mp3/browse/playlist-4.webp"
    }, {
